export default function TempSection() {
  return (
    <section className="flex flex-col items-center">
      ...
      <div>
        <h1 className="font-display text-edge-outline animate-title z-10 whitespace-nowrap bg-orange-300 bg-clip-text py-4 text-4xl text-transparent duration-1000 sm:text-8xl xl:text-9xl">
          SoleStyle
        </h1>
        <p className="font-display animate-fade-in text-edge-outline text-right text-2xl italic text-orange-200">
